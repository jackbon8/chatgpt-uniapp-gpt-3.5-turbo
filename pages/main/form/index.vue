			...
			<u-transition :show="true" mode="fade-left">
				<view class="panel">
					<view class="head">
						...
						<!-- <view class="tips">智能对话</view> -->
					</view>
					<view class="textarea">
						<u--textarea height="140" placeholder="支持长按粘贴您的问题" v-model="problem"></u--textarea>
					</view>
					<view class="btn-group">
						<view class="btn paste">
							<u-button icon="file-text" @tap="paste" text="粘贴问题"></u-button>
						</view>
						<view class="btn get">
							<u-button @click="onSubmitGPT" iconColor="#ffffff" color="#26B3A0" icon="edit-pen" text="获取问题答案"></u-button>
						</view>
					</view>
				</view>
			</u-transition>
...
<script>
	...
	export default {
		...
		methods: {
			onSubmitGPT() {
				if(!_this.problem){
					_this.$u.toast('请输入您的问题')
					return false;
				}
				uni.navigateTo({
					url:'/pages/main/answer/index?from=form&value='+_this.problem
				})
			},
			paste(){
				console.log('粘贴内容')
